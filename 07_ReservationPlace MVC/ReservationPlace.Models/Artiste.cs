...
{
    /* La classe "Artiste" dépend de "ICoordonnées" et de "IId" il est don nécessaire d'implémenter les propriétés respectives
    ...
    public class Artiste : ICoordonnees,IId
    {
       
        public int Id { get; set; }
        // on instancie Coordonnees car c'est un objet qui fait partie d'un objet tout dépend du fonctionnel 
